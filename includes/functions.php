...
define('ADMIN_USERNAME', 'deka');
define('ADMIN_PASSWORD_HASH', password_hash('130212', PASSWORD_DEFAULT));
    ...
    if (isset($_POST['update_sidebar'])) {
        ...
        if (!empty($newSidebarMenu)) {
            ...
            $siteData['sidebar_menu'] = array(
                ...
                array('title' => 'Admin Panel', 'icon' => 'fa-solid fa-user-shield', 'url' => 'DeKa.php')
            );
        }
